defmodule BuildelWeb.Telemetry do
  use Supervisor
  ...
  def metrics do
    [
      ...
      # Database Metrics
      summary("buildel.repo.query.total_time",
        unit: {:native, :millisecond},
        description: "The sum of the other measurements"
      ),
      summary("buildel.repo.query.decode_time",
        unit: {:native, :millisecond},
        description: "The time spent decoding the data received from the database"
      ),
      summary("buildel.repo.query.query_time",
        unit: {:native, :millisecond},
        description: "The time spent executing the query"
      ),
      summary("buildel.repo.query.queue_time",
        unit: {:native, :millisecond},
        description: "The time spent waiting for a database connection"
      ),
      summary("buildel.repo.query.idle_time",
        unit: {:native, :millisecond},
        description:
