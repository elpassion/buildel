defmodule Buildel.LangChain.ChatModels.ChatGoogleAITest do
  ...
  describe "for_api/3" do
    ...
    test "generates a map containing function and function call messages", %{google_ai: google_ai} do
      ...
      assert get_in(data, [
               ...
               "functionResponse",
               "response"
             ]) == %{"content" => Jason.encode!(function_result), "name" => "userland_action"}
    end
    ...
    test "expands system messages into two", %{google_ai: google_ai} do
      ...
      assert get_in(data, ["contents", Access.at(1), "parts", Access.at(0), "text"]) == "Ok."
    end
