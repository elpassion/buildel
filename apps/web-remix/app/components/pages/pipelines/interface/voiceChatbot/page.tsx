...
export function VoiceChatbotPage() {
  ...
  const websiteFormUrl = `${pageUrl}${routes.voiceChatPreview(
    organizationId,
    pipelineId,
  ...
  return (
    <div>
      <div className="flex flex-col gap-3 mb-6 md:justify-between md:flex-row md:items-center">
        <div>
          <h2 className="text-lg text-foreground font-medium">Voice Chatbot</h2>
      ...
      <InterfaceSectionWrapper>
        <InterfaceSectionHeader>
          ...
          <InterfaceSectionHeaderParagraph>
            Integrate your Buildel Voice Chat easily on your website.
          </InterfaceSectionHeaderParagraph>
        </InterfaceSectionHeader>
