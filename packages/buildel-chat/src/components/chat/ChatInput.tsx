...
import { ChatInputProps } from "~/components/chat/chat.types";
...
export function ChatInput({
  ...
  return (
    <div
      className={cn(
        "relative overflow-hidden border border-input bg-white flex items-center min-h-fit h-auto shrink-0 w-full flex-col max-w-[820px] mx-auto",
        {
  ...
  return (
    <button
      ...
      className={cn(
        ...
        {
          "bottom-[4px] right-1.5 w-6 h-6": size === "sm",
